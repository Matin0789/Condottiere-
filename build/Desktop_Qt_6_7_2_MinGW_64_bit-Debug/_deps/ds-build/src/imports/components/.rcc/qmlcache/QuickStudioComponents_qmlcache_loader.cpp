...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt-project.org/imports/QtQuick/Studio/Components/IsoItem.qml"), &QmlCacheGeneratedCode::_qt_0x2d_project_0x2e_org_imports_QtQuick_Studio_Components_IsoItem_qml::unit);

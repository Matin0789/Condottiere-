...
ما از ورژن \lr{QT6\_widget} استفاده کردیم و برنامه را به صورت شی گرا برای کاربران به نمایش میگذاریم.\\
	...
	\begin{itemize}
        ...
        \lr{back\_end} در این کلاس از کلاس های گرافیکی پیش فرض خود کیوتی استفاده کردیم و روابطی با بقیه کلاس ها برقرار کردیم و همچنین از ساختار داده ای مپ استفاده نموده ایم که در پایین برایتان توضیح خواهیم داد :
		\begin{latin}
			\begin{itemize}
				\item Ui::Campaign *ui
		...
		\lr{back\_end}  این کلاس دو داده خصوصی دو اسلات خصوصی و یک تابع دارد :
		\begin{latin}
			\begin{itemize}
		...
		\paragraph{صفات و ویژگی ها} 
        \lr{back\_end} این کلاس برای نمایش توضیحات بازی و کارت ها ست که از 4 تابع برای کلید ها و دو داده خصوصی ساخته شده :
		\begin{latin}
			\begin{itemize}
		...
		\paragraph{صفات و ویژگی ها} 
        \lr{back\_end} این کلاس شامل یک شی از کلاس پیش فرض گرافیکی خود کیوتی و چندین توابع برای کلید های این صفحه :
		\begin{latin}
			\begin{itemize}
		...
		\begin{latin}
			\begin{itemize}
				...
				\item Campaign\ *campaign
				\item Game\ *game
				\item Locateinfo\ *battleground\_page
				\item Locateinfo\ *favorground\_page
			\end{itemize}
		\end{latin}
		...
		\paragraph{صفات و ویژگی ها} 
        \lr{back\_end} این کلاس فقط شامل توابع کلید ها میشود : 
		\begin{latin}
			\begin{itemize}
		...
		\item \lr{setplayer} \\
		\paragraph{صفات و ویژگی ها} 
		\lr{back\_end}  این کلاس شامل یک داده ساختاری مپ از رنگ های نشان بازیکنان و دو تابع برای کلید است.
		\begin{latin}
			\begin{itemize}
		...
		\lr{back\_end} این کلاس درواقع سخت ترین قسمت این پروژه بود که از بسیاری از کلاس های پیش فرض میوتی در آن استفاده کرده ایم  در ادامه لیستی از تمام اشیاء مورد نیاز این صفحه را خواهید دید.\\ :
		\begin{latin}
			\begin{itemize}
		...
		\item \lr{savegame}  این صفحه برای ذخبره بازی انجام میشود\\
		\paragraph{صفات و ویژگی ها} 
        \lr{back\_end}  این صفحه چیز خاصی ندارد:
		\begin{latin}
			\begin{itemize}
				\item Ui::saveGame\ *ui
			\end{itemize}
		...
		\item \lr{warWinner}   در این صفحه برنده جنگ نمایش داده میشود \\
		\paragraph{صفات و ویژگی ها} 
		...
		\item \lr{loadgames}  در این صفحه بازی های ذخیره شده نمایش داده میشوند \\
		\paragraph{صفات و ویژگی ها} 
		\begin{latin}
			\begin{itemize}
